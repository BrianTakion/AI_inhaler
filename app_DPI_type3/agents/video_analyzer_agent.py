...
import re
import class_PromptBank_DPI_type3 as PB
...
Q1. {self.promptbank.check_action_step_DPI_type3['sit_stand']['action']}
Q2. {self.promptbank.check_action_step_DPI_type3['remove_cover']['action']}
Q3. {self.promptbank.check_action_step_DPI_type3['load_dose']['action']}
...
Q1. {self.promptbank.check_action_step_DPI_type3['exhale_before']['action']}
Q2. {self.promptbank.check_action_step_DPI_type3['seal_lips']['action']}
Q3. {self.promptbank.check_action_step_DPI_type3['inhale_deeply']['action']}
Q4. {self.promptbank.check_action_step_DPI_type3['remove_inhaler']['action']}
Q5. {self.promptbank.check_action_step_DPI_type3['hold_breath']['action']}
Q6. {self.promptbank.check_action_step_DPI_type3['exhale_after']['action']}
Q7. {self.promptbank.check_action_step_DPI_type3['clean_inhaler']['action']}
