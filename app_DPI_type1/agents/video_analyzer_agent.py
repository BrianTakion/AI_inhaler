    ...
    def process(self, state: VideoAnalysisState) -> VideoAnalysisState:
        ...
        try:
            ...
            promptbank_data = {
                ...
                "check_action_step_DPI_type1": self.promptbank.check_action_step_DPI_type1
            }
...
Q1: {self.promptbank.check_action_step_DPI_type1['sit_stand']['action']}
...
Q1. {self.promptbank.check_action_step_DPI_type1['sit_stand']['action']}
Q2. {self.promptbank.check_action_step_DPI_type1['load_dose']['action']}
Q3. {self.promptbank.check_action_step_DPI_type1['inspect_mouthpiece']['action']}
Q4. {self.promptbank.check_action_step_DPI_type1['hold_inhaler']['action']}
Q5. {self.promptbank.check_action_step_DPI_type1['exhale_before']['action']}
...
Q1. {self.promptbank.check_action_step_DPI_type1['exhale_before']['action']}
Q2. {self.promptbank.check_action_step_DPI_type1['seal_lips']['action']}
Q3. {self.promptbank.check_action_step_DPI_type1['inhale_deeply']['action']}
Q4. {self.promptbank.check_action_step_DPI_type1['remove_inhaler']['action']}
Q5. {self.promptbank.check_action_step_DPI_type1['hold_breath']['action']}
Q6. {self.promptbank.check_action_step_DPI_type1['exhale_after']['action']}
...
"""
    ...
    def _create_action_summary(self, promptbank_data: dict) -> dict:
        ...
        for action_key, action_data in check_action_step_DPI_type1.items():
