...
def main():
    ...
    #   "gpt-5-nano", "gpt-4.1", "gpt-5-mini", "gpt-5.1", "gpt-5.2",
    #   "gemini-2.5-flash-lite", "gemini-2.5-flash", "gemini-2.5-pro", "gemini-3-pro-preview"
    
    llm_models = ["gpt-4.1"]  # gemini-3-flash-preview로 변경
    ...
    # 비디오 파일 설정
    # ========================================
    base_dir = r"/workspaces/AI_inhaler/app_DPI_type1/video_source/"
    video_options = {
        "video1": base_dir + r"DPI-7 Ellipta.MOV",
        "video2": base_dir + r"DPI-12 Ellipta.MOV"
    }
