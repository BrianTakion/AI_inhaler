...
class ReporterAgent:
    ...
    # 액션 순서 정의 (밑에서 위로)
    ACTION_ORDER = [
        'sit_stand', 'remove_cover', 'load_dose', 'inspect_mouthpiece', 
        'hold_inhaler', 
    ...
    def _apply_individual_agent_rule(self, reference_times: dict, promptbank_data: dict) -> dict:
        ...
        # 데이터 가져오기
        actions_data = promptbank_data.get("check_action_step_SMI_type1", {})
    ...
    def _create_final_report(self, state: VideoAnalysisState, 
        ...
        for model_id, result in model_results.items():
            promptbank_data = result.get("promptbank_data", {})
            check_action = promptbank_data.get("check_action_step_SMI_type1", {})
    ...
    def _create_individual_agent_visualization(self, model_id: str, model_name: str, 
        ...
        try:
            ...
            check_action_step_SMI_type1 = promptbank_data.get("check_action_step_SMI_type1", {})
