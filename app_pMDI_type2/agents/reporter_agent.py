...
class ReporterAgent:
    ...
    def _apply_individual_agent_rule(self, reference_times: dict, promptbank_data: dict) -> dict:
        ...
        # 데이터 가져오기
        actions_data = promptbank_data.get("check_action_step_pMDI_type2", {})
        ...
        # 2. T_in ~ T_face 구간 (pMDI_type2에는 shake_inhaler가 없으므로 이 구간 처리 없음)
    ...
    def _evaluate_decisions(self, reference_times_avg: dict, promptbank_data_avg: dict) -> dict:
        ...
        # 데이터 가져오기
        actions_data = promptbank_data_avg.get("check_action_step_pMDI_type2", {})
    ...
    def _create_final_report(self, state: VideoAnalysisState, 
        ...
        for model_id, result in model_results.items():
            promptbank_data = result.get("promptbank_data", {})
            check_action = promptbank_data.get("check_action_step_pMDI_type2", {})
    ...
    def _create_individual_agent_visualization(self, model_id: str, model_name: str, 
        ...
        try:
            ...
            action_keys = list(check_action_step_pMDI_type2.keys())
            ...
            # Confidence 딕셔너리 생성
            confidence_dict = {}
            for key, value in check_action_step_pMDI_type2.items():
    ...
    def _create_visualization(self, state: VideoAnalysisState):
        ...
        try:
            ...
            check_action_step_pMDI_type2 = promptbank_data_avg["check_action_step_pMDI_type2"]
