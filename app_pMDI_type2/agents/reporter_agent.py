...
class ReporterAgent:
    ...
    def _compute_average(self, state: VideoAnalysisState) -> dict:
        ...
        # check_action_step_pMDI_type2 평균
        check_action_step_pMDI_type2_avg = {}
        all_action_keys = set()
        for model_id, result in model_results.items():
            promptbank = result.get("promptbank_data", {})
            check_action = promptbank.get("check_action_step_pMDI_type2", {})
        ...
        for action_key in all_action_keys:
            ...
            check_action_step_pMDI_type2_avg[action_key] = {
        ...
        promptbank_data_avg = {
            ...
            "check_action_step_pMDI_type2": check_action_step_pMDI_type2_avg
        }
    ...
    def _create_final_report(self, state: VideoAnalysisState) -> dict:
        ...
        if promptbank_data_avg:
            check_action_step_pMDI_type2 = promptbank_data_avg.get("check_action_step_pMDI_type2", {})
