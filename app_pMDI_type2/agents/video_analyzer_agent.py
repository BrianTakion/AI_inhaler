    ...
    def process(self, state: VideoAnalysisState) -> VideoAnalysisState:
        ...
        try:
            ...
            promptbank_data = {
                ...
                "check_action_step_pMDI_type2": self.promptbank.check_action_step_pMDI_type2
            }
...
Q1: {self.promptbank.check_action_step_pMDI_type2['sit_stand']['action']}
...
Q1. {self.promptbank.check_action_step_pMDI_type2['sit_stand']['action']}
Q2. {self.promptbank.check_action_step_pMDI_type2['remove_cover']['action']}
Q3. {self.promptbank.check_action_step_pMDI_type2['inspect_mouthpiece']['action']}
Q4. {self.promptbank.check_action_step_pMDI_type2['hold_inhaler']['action']}
Q5. {self.promptbank.check_action_step_pMDI_type2['exhale_before']['action']}
...
Q1. {self.promptbank.check_action_step_pMDI_type2['exhale_before']['action']}
Q2. {self.promptbank.check_action_step_pMDI_type2['seal_lips']['action']}
Q3. {self.promptbank.check_action_step_pMDI_type2['inhale_deeply']['action']}
Q4. {self.promptbank.check_action_step_pMDI_type2['remove_inhaler']['action']}
Q5. {self.promptbank.check_action_step_pMDI_type2['hold_breath']['action']}
Q6. {self.promptbank.check_action_step_pMDI_type2['exhale_after']['action']}
...
"""
    ...
    def _create_action_summary(self, promptbank_data: dict) -> dict:
        ...
        """
        action_summary = {}
        check_action_step_pMDI_type2 = promptbank_data.get("check_action_step_pMDI_type2", {})
        
        for action_key, action_data in check_action_step_pMDI_type2.items():
