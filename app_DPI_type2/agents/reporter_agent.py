...
class ReporterAgent:
    ...
    def _compute_average(self, state: VideoAnalysisState) -> dict:
        ...
        # check_action_step_DPI_type2 평균
        check_action_step_DPI_type2_avg = {}
        all_action_keys = set()
        for model_id, result in model_results.items():
            promptbank = result.get("promptbank_data", {})
            check_action = promptbank.get("check_action_step_DPI_type2", {})
        ...
        for action_key in all_action_keys:
            ...
            check_action_step_DPI_type2_avg[action_key] = {
        ...
        promptbank_data_avg = {
            ...
            "check_action_step_DPI_type2": check_action_step_DPI_type2_avg
        }
    ...
    def _evaluate_decisions(self, reference_times_avg: dict, promptbank_data_avg: dict) -> dict:
        ...
        # 데이터 가져오기
        actions_data = promptbank_data_avg.get("check_action_step_DPI_type2", {})
    ...
    def _create_final_report(self, state: VideoAnalysisState) -> dict:
        ...
        if promptbank_data_avg:
            check_action_step_DPI_type2 = promptbank_data_avg.get("check_action_step_DPI_type2", {})
    ...
    def _create_visualization(self, state: VideoAnalysisState):
        ...
        try:
            ...
            check_action_step_DPI_type2 = promptbank_data_avg["check_action_step_DPI_type2"]
            
            # 모든 키와 y 위치 설정 (REFERENCE_ORDER, ACTION_ORDER 순서 적용, 밑에서 위로)
            reference_keys = list(search_reference_time.keys())
            action_keys = list(check_action_step_DPI_type2.keys())
            ...
            # Confidence 딕셔너리 생성
            confidence_dict = {}
            for key, value in check_action_step_DPI_type2.items():
